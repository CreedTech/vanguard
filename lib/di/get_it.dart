...
Future init() async {
  ...
  getItInstance.registerLazySingleton<MovieRemoteDataSource>(
      () => MovieRemoteDataSourceImpl(getItInstance(), http: getItInstance()));
  ...
  //! Core
  getItInstance.registerLazySingleton(() => NavigatorHelper());
  getItInstance.registerLazySingleton(() => RouterGenerator());
  getItInstance.registerLazySingleton<NetworkContainer>(
          () => NetworkContainerImpl(dio: getItInstance()));
  getItInstance.registerLazySingleton<NetworkChecher>(() => (NetworkCheckerImpl()));
